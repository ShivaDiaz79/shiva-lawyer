  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      ...
      <p className="mx-auto mt-4 max-w-sm text-gray-500">
       El derecho no esta en la norma sino en la conducta. Por eso el derecho es vida humana viviente.<br/> 
       No se interpreta la norma sino la conducta, es una hermeneutica existencial. <br/>
       Carlos Cossio.
      </p>
